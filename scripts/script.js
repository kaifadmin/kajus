...
// 24 UNIQUE ITEMS - Mapped to your Local Folders
// Image structure: images/[Folder Name]/1.jpg, 2.jpg, 3.jpg
const allProducts = [
    // CASHEWS
    { 
        id: 1, 
...
function updateCartUI() {
    ...
    if(cartItemsContainer) {
        ...
        if (cart.length === 0) {
            ...
            `;
            // Disable footer buttons if empty
...
function submitContactForm(e) {
    ...
    const originalText = btn.innerHTML; // Saves icon + text
    ...
    setTimeout(() => {
        ...
        btn.classList.add('success'); // Adds green background via CSS
        btn.style.opacity = '1';
        ...
        // 5. Revert button after 3 seconds
        setTimeout(() => {
...
function newsletterSubmit(e) {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            btn.style.color = '#145A32'; // Revert to secondary color
        }, 2500);
    }, 1200);
}